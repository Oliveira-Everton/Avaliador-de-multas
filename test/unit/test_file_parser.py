...
class TestFileManager(unittest.TestCase):
    ...
    def test_take_national_identity_cards(self):
        ...
        take_national_name_and_number_identity_cards = csv_file.take_national_identity_cards()
    ...
    def test_take_national_identity_cards_with_license_plate(self):
        ...
        identity_cards_with_license_plate = csv_file.take_national_identity_cards_with_license_plate()

        self.assertEqual(
            identity_cards_with_license_plate,
            [
                ["467191153", "Josevaldo Cal. O. Teiro"],
                ["467191153", "Josevaldo Cal. O. Teiro"],
                ["467191153", "Josevaldo Cal. O. Teiro"],
